...
<head>
 ...
 <meta name="csrf-token" content="{{ csrf_token() }}">
  ...
  <link href="demand/dashbord/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

  <!-- Custom styles for this template-->
  <link href="demand/dashbord/css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <script src="demand/dashbord/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Core plugin JavaScript-->
  <script src="demand/dashbord/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="demand/dashbord/js/sb-admin-2.min.js"></script>

  <!-- Page level plugins -->
  <script src="demand/dashbord/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="demand/dashbord/js/demo/chart-area-demo.js"></script>
